...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002167205597 -1002308128053').split()]  # Channel id for auto indexing (make sure bot is admin)
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002452855325')  # Channel/Group ID for force sub (make sure bot is admin)
...
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002452855325 -1002188150109').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://imdb:Preethu@cluster0.ongns.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Movies_Hub_0101')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Brand_01_01_01')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Brand_01_01')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/Brand_01_01_01')
